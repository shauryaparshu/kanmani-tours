  ...
  return (
    <div style={{ backgroundColor: '#FAFAF7', minHeight: '100vh' }}>
      ...
      <section style={{ padding: '120px 20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '64px', alignItems: 'center', marginBottom: '120px' }}>
          <div>
            <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '42px', color: '#1C1917', marginBottom: '24px' }}>The Adventurer</h2>
            <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '20px', color: '#4A4540', lineHeight: '1.8' }}>
              <p style={{ marginBottom: '24px' }}>Beyond academia and diplomacy, an insatiable adventurous spirit drives her. She boldly led the first Indian Women's Everest Base Camp Expedition from Tamil Nadu, undertaking rigorous training at the Himalayan Mountaineering Institute. Her athletic prowess also earned her the honor of carrying the Indian national flag as the Flag Bearer at the Asian Games.</p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ aspectRatio: '4/3', backgroundColor: '#E8E4DC', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #D4CFC9' }}>
              <span style={{ fontFamily: "'Jost', Arial, sans-serif", fontSize: '12px', color: '#9A948F', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Expeditions Era</span>
            </div>
            <div style={{ aspectRatio: '4/3', backgroundColor: '#E8E4DC', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #D4CFC9' }}>
              <span style={{ fontFamily: "'Jost', Arial, sans-serif", fontSize: '12px', color: '#9A948F', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Recent Era</span>
            </div>
          </div>
        </div>
