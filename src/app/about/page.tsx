  ...
  return (
    <main className="about-page">
      ...
      <style jsx>{`
                ...
                .about-story-grid { display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 60px; align-items: flex-start; }
                ...
                .section-title-large { font-size: clamp(2rem, 4vw, 3rem); font-weight: 900; color: #1e293b; margin-bottom: 30px; line-height: 1.2; }
                .story-paragraph { font-size: 1.1rem; color: #475569; margin-bottom: 24px; line-height: 1.8; }
                .story-img-wrap { position: relative; }
                .story-img { border-radius: 24px; box-shadow: 0 20px 40px rgba(0,0,0,0.08); width: 100%; height: auto; display: block; object-fit: cover; background: #f1f5f9; }
                .story-attribution { margin-top: 24px; display: flex; flex-direction: column; border-left: 4px solid var(--primary); padding-left: 20px; }
                .story-attribution strong { color: #1e293b; font-size: 1.25rem; font-weight: 900; }
                .story-attribution span { color: var(--primary); font-weight: 700; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.05em; }
