// SocialIcons — reusable social media links with "Follow us on X" tooltips
// variant: 'topbar' = small inline icons; 'card' = large square buttons
...
export default function SocialIcons({ variant = 'card' }: SocialIconsProps) {
    if (variant === 'topbar') {
        return (
            <>
                {SOCIALS.map((s) => (
                    <a
                        key={s.name}
                        href={s.href}
                        className="top-bar-social social-tooltip-wrap"
                        aria-label={s.name}
                        data-tooltip={`Follow us on ${s.name}`}
                    >
                        {s.icon}
                    </a>
                ))}
        ...
        <div className="contact-social-links">
            {SOCIALS.map((s) => (
                <a
                    key={s.name}
                    href={s.href}
                    className="contact-social-item social-tooltip-wrap"
                    aria-label={s.name}
                    data-tooltip={`Follow us on ${s.name}`}
                >
                    {s.icon}
