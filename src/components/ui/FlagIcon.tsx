...
export default function FlagIcon({ country, width = 28, height = 20 }: FlagIconProps) {
  return (
    <div className="flag-icon-wrapper" style={{ width: `${width}px`, height: `${height}px` }}>
      {country === 'india' && (
        <svg viewBox="0 0 28 20" className="flag-svg" width={width} height={height} aria-label="Flag of India">
          {/* Saffron */}
      ...
      {country === 'japan' && (
        <svg viewBox="0 0 28 20" className="flag-svg" width={width} height={height} aria-label="Flag of Japan">
